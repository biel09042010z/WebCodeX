...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === 'POST') {
      const { nome, email, telefone, tipo_negocio, plano_id, mensagem } = req.body;
      ...
      const resultado = await sql`
        INSERT INTO pedidos (nome, email, telefone, tipo_negocio, plano_id, mensagem)
        VALUES (${nome}, ${email}, ${telefone || null}, ${tipo_negocio || null}, ${plano_id || null}, ${mensagem || null})
        RETURNING id
      `;
